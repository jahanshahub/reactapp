...
import Group6322 from "../Group6322";
import NFTList from "../NFTList";
import ButtonDefault2 from "../ButtonDefault2";
import DesktopFooterLight2 from "../DesktopFooterLight2";
import Headline from "../Headline";
import styled from "styled-components";
import {
  InterNormalWhite46px,
  Link,
  InterNormalWhite80px,
  InterNormalWhite32px,
  InterBoldWhite36px,
  InterSemiBoldWhite55px,
            ...
            <OverlapGroupContainer1>
              ...
              <OverlapGroup5>
                ...
                <Roadmap id="roadmap">
                  ...
                  <GroupContainer>
                    <Group6322>{group63221Props.children}</Group6322>
                    <Group6322 className={group63222Props.className}>{group63222Props.children}</Group6322>
                    <Group6322 className={group63223Props.className}>{group63223Props.children}</Group6322>
                  </GroupContainer>
                </Roadmap>
                <Group70 id="group-70">
                  <OverlapGroup2>
                  ...
                  <Group69>
                    ...
                    <OverlapGroup1>
                      ...
                      <ButtonDefault2 chevronRight1={buttonDefault2Props.chevronRight1} />
                      <X1261 src={x1261} />
                      <X2170 src={x2170} />
                      <X2705 src={x2705} />
                    </OverlapGroup1>
...
const WhatIsCthulhuClub = styled.div`
  ${InterNormalWhite80px}
  position: absolute;
  width: 642px;
  top: 426px;
...
const CthulhuClubIsDesi = styled.div`
  ${InterLightWhite22px}
  position: absolute;
  width: 633px;
  top: 647px;
...
const NFTMarketplace = styled.div`
  position: absolute;
  width: 303px;
  height: 218px;
  top: 0;
...
const FAQ = styled.div`
  ${InterNormalWhite115px}
  width: 301.47406005859375px;
  height: 217.51504516601562px;
  letter-spacing: 0;
`;
...
const MintNowButton = styled.img`
  position: absolute;
  width: 179px;
  height: 49px;
  top: 591px;
